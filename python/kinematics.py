...
body3_id = m.AddBody(body1_id, st, joint3, body3, "Link3")
...
print km.CalcPointJacobian(m, Q, 1, np.array([0.5, 0., 0.]), True)
...
Qres = km.InverseKinematics(m, Qinit, body_id, body_point, target_pos, step_tol, lamda, max_iter) 	 # Does not work! Qres is the output joint positions. How to make Python understand that?
print Qres
